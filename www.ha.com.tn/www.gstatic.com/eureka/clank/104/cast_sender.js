(function() {
    ...
    */
    ...
    x("chrome.cast.ReceiverAvailability", chrome.cast.R);
    chrome.cast.Gb = {
        CHROME: "chrome",
        IOS: "ios",
        ANDROID: "android"
    ...
    x("chrome.cast.media.ContainerType", chrome.cast.media.W);
    chrome.cast.media.G = {
        GENERIC: 0,
        MOVIE: 1,
        TV_SHOW: 2,
    ...
    x("chrome.cast.media.RepeatMode", chrome.cast.media.X);
    ...
    chrome.cast.media.V = function(a) {
        this.containerType = a = void 0 === a ? chrome.cast.media.W.GENERIC_CONTAINER : a;
        this.containerDuration = this.containerImages = this.sections = this.title = void 0
    };
    x("chrome.cast.media.ContainerMetadata", chrome.cast.media.V);
    ...
    chrome.cast.media.ia = function() {
        chrome.cast.media.V.call(this, chrome.cast.media.W.AUDIOBOOK_CONTAINER);
        this.releaseDate = this.publisher = this.narrators = this.authors = void 0
    };
    q(chrome.cast.media.ia, chrome.cast.media.V);
    ...
    x("chrome.cast.media.timeout.getStatus", chrome.cast.media.timeout.T);
    ...
    x("chrome.cast.media.timeout.setVolume", chrome.cast.media.timeout.U);
    chrome.cast.media.timeout.S = 0;
    x("chrome.cast.media.timeout.editTracksInfo", chrome.cast.media.timeout.S);
    ...
    chrome.cast.media.xb = function(a) {
        ...
        this.items = a;
        this.startIndex = 0;
        this.repeatMode = chrome.cast.media.X.OFF;
        this.customData = null
    };
    ...
    chrome.cast.media.P = function() {
        this.type = "QUEUE_UPDATE";
        this.customData = this.jump = this.currentItemId = this.sessionId = this.requestId = null
    };
    x("chrome.cast.media.QueueJumpRequest", chrome.cast.media.P);
    ...
    f.T = function(a, b, c) {
        ...
        D.o(this, "MEDIA_GET_STATUS", a, b, c, chrome.cast.media.timeout.T)
    };
    ...
    f.Ka = function(a, b, c, d) {
        ...
        a.o(this, "PLAY", b, c, d, chrome.cast.media.timeout.play)
    };
    ...
    f.Ja = function(a, b, c, d) {
        ...
        a.o(this, "PAUSE", b, c, d, chrome.cast.media.timeout.pause)
    };
    ...
    f.U = function(a, b, c) {
        D.o(this, "MEDIA_SET_VOLUME", a, b, c, chrome.cast.media.timeout.U)
    };
    f.S = function(a, b, c) {
        D.o(this, "EDIT_TRACKS_INFO", a, b, c, chrome.cast.media.timeout.S)
    };
    f.mc = function(a, b, c) {
        D.o(this, "QUEUE_INSERT", a, b, c, chrome.cast.media.timeout.v)
    };
    f.lc = function(a, b, c) {
        D.o(this, "QUEUE_INSERT", new chrome.cast.media.va([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.wc = function(a, b, c) {
        D.o(this, "QUEUE_UPDATE", a, b, c, chrome.cast.media.timeout.v)
    };
    f.rc = function(a, b) {
        var c = new chrome.cast.media.P;
        c.jump = -1;
    ...
    f.sc = function(a, b, c) {
        0 > Ka(this, a) || D.o(this, "QUEUE_REMOVE", new chrome.cast.media.xa([a]), b, c, chrome.cast.media.timeout.v)
    };
    f.uc = function(a, b, c) {
    ...
    chrome.cast.media.h.prototype.removeUpdateListenerWithContext = chrome.cast.media.h.prototype.O;
    chrome.cast.media.h.prototype.removeUpdateListener = chrome.cast.media.h.prototype.da;
    chrome.cast.media.h.prototype.addUpdateListenerWithContext = chrome.cast.media.h.prototype.M;
    ...
    chrome.cast.media.h.prototype.editTracksInfo = chrome.cast.media.h.prototype.S;
    chrome.cast.media.h.prototype.setVolume = chrome.cast.media.h.prototype.U;
    ...
    chrome.cast.media.h.prototype.getStatus = chrome.cast.media.h.prototype.T;
    var D = null;
    ...
    f.Qa = function(a, b, c, d, e) {
        a.Bc(new La(this.sessionId, b, c), d, e)
    };
    f.aa = function(a) {
        this.M(D, a)
    };
    ...
    chrome.cast.j.prototype.removeMessageListenerWithContext = chrome.cast.j.prototype.Ma;
    chrome.cast.j.prototype.removeMessageListener = chrome.cast.j.prototype.zc;
    chrome.cast.j.prototype.removeMediaListenerWithContext = chrome.cast.j.prototype.La;
    chrome.cast.j.prototype.removeMediaListener = chrome.cast.j.prototype.ba;
    chrome.cast.j.prototype.addMediaListenerWithContext = chrome.cast.j.prototype.Fa;
    chrome.cast.j.prototype.addMediaListener = chrome.cast.j.prototype.Y;
    chrome.cast.j.prototype.addMessageListenerWithContext = chrome.cast.j.prototype.Ga;
    chrome.cast.j.prototype.addMessageListener = chrome.cast.j.prototype.Yb;
    chrome.cast.j.prototype.removeUpdateListenerWithContext = chrome.cast.j.prototype.O;
    chrome.cast.j.prototype.removeUpdateListener = chrome.cast.j.prototype.da;
    chrome.cast.j.prototype.addUpdateListenerWithContext = chrome.cast.j.prototype.M;
    chrome.cast.j.prototype.addUpdateListener = chrome.cast.j.prototype.aa;
    chrome.cast.j.prototype.sendMessageWithContext = chrome.cast.j.prototype.Qa;
    chrome.cast.j.prototype.sendMessage = chrome.cast.j.prototype.sendMessage;
    chrome.cast.j.prototype.stopWithContext = chrome.cast.j.prototype.Ua;
    chrome.cast.j.prototype.stop = chrome.cast.j.prototype.stop;
    chrome.cast.j.prototype.leave = chrome.cast.j.prototype.hc;
    chrome.cast.j.prototype.getDialAppInfoWithContext = chrome.cast.j.prototype.Ia;
    chrome.cast.j.prototype.getDialAppInfo = chrome.cast.j.prototype.getDialAppInfo;
    chrome.cast.j.prototype.setReceiverMutedWithContext = chrome.cast.j.prototype.Ra;
    chrome.cast.j.prototype.setReceiverMuted = chrome.cast.j.prototype.Ec;
    chrome.cast.j.prototype.setReceiverVolumeLevelWithContext = chrome.cast.j.prototype.Sa;
    ...
    var Ta = function(a) {
            ...
            if ("function" == typeof a.s) return new G(function() {
                return a.s()
            });
    ...
    var M = function(a, b) {
            return L(a.i, b) ? (delete a.i[b], --a.size, a.l++, a.g.length > 2 * a.size && K(a), !0) : !1
        },
        K = function(a) {
            ...
            if (a.size != a.g.length) {
                var e = {};
                for (c = b = 0; b < a.g.length;) d = a.g[b], L(e, d) || (a.g[c++] = d, e[d] = 1), b++;
                a.g.length = c
            }
        };
    f = J.prototype;
    f.get = function(a, b) {
        return L(this.i, a) ? this.i[a] : b
    };
    f.set = function(a, b) {
        L(this.i, a) || (this.size += 1, this.g.push(a), this.l++);
        this.i[a] = b
    };
    ...
    f.keys = function() {
        return Ta(this.s(!0)).i()
    };
    f.values = function() {
        return Ta(this.s(!1)).i()
    };
    f.entries = function() {
        var a = this;
    ...
    P.prototype.connect = function(a) {
        ...
        Za(this, new O("client_connect", this.i))
    };
    ...
    var bb = function(a, b, c, d, e, h, k, l, p, v, ib, jb) {
            this.J = a;
            this.g = b || null;
            this.l = c || null;
            this.B = d || null;
        ...
        cb = function(a) {
            ...
            a.i && b.push(ab(new $a(a.i, a.I, a.g)));
            return b
        };
    var db = function() {
            this.g = {};
    ...
    var kb = B("Gecko") && !(-1 != Ba().toLowerCase().indexOf("webkit") && !B("Edge")) && !(B("Trident") || B("MSIE")) && !B("Edge"),
    ...
    R.prototype.A = function(a) {
        this.m = arguments;
        this.g || this.l ? this.i = !0 : nb(this)
    };
    ...
    R.prototype.resume = function() {
        this.l--;
        this.l || !this.i || this.g || (this.i = !1, nb(this))
    };
    var nb = function(a) {
        a.g = mb(function() {
            a.g = null;
    ...
    var rb = function(a) {
        if (a.N && "function" == typeof a.N) return a.N();
    ...
    var V = function() {
        ...
        W = function(a, b, c, d) {
            ...
            d = Za(a.A, b);
            c && d && (a =
                Ya(a.K, b.sequenceNumber)) && (b = new chrome.cast.Error(chrome.cast.C.INVALID_PARAMETER, d), (a = a.g) && a(b))
        };
    V.prototype.initialize = function(a, b) {
        ...
        a.invisibleSender || (a = new PresentationRequest(X(this)), a.getAvailability().then(function(d) {
            d.onchange = function() {
                c.la = !!d.value;
                c.g.receiverListener(d.value ? chrome.cast.R.AVAILABLE : chrome.cast.R.UNAVAILABLE)
            };
            d.onchange()
        }, function() {
            c.g.receiverListener(chrome.cast.R.AVAILABLE)
    ...
    var Y = function(a, b, c) {
        ...
        wb = function(a) {
            var b = Z;
            ub.has(a.type) && b.la && (b.m ? (a.sessionId = b.m, vb(b, null, a.type, a, function() {}, function() {})) : b.kb.A(X(b, void 0, "urn:x-cast:com.google.cast.media",
                a)))
        };
    ...
    V.prototype.requestSession = function(a, b, c) {
        var d = this;
        this.l ? sb(b) : (c = X(this, c), this.l = a, (new PresentationRequest(c)).start().then(function(e) {
            Y(d, e, b)
        }).catch(function(e) {
            d.l = null;
    ...
    var X = function(a, b, c, d) {
        ...
        var k = b.dialRequest;
        k && (e = k.appName, (h = k.launchParameter) && !h.match(xb) && (h = qb(h)));
        var l = [];
        l.push({
            appId: b.appId,
        ...
        return cb(new bb(l, a.A.i, a.g.autoJoinPolicy, a.g.defaultActionPolicy, b.requestSessionTimeout, e, h, a.g.invisibleSender, c, d, b.androidReceiverCompatible, b.credentialsData))
    };
    V.prototype.Pa = function(a, b, c, d) {
        var e = this;
        this.D++;
        vb(this, null, b, a, function(h) {
            e.D--;
            h.l = !0;
            c && c(h)
        }, function(h) {
    ...
    V.prototype.o = function(a, b, c, d, e, h) {
        var k = this;
        vb(this, a, b, c, function(l) {
            k.Ha(l);
            d && d(void 0)
        }, e, h)
    };
    var vb = function(a, b, c, d, e, h, k) {
        ...
        a.Oa(d, function(l) {
            l.status && 1 == l.status.length ? e && e(l.status[0]) : (l = new chrome.cast.Error(chrome.cast.C.SESSION_ERROR), h && h(l))
        }, h, k)
    };
    f = V.prototype;
    ...
    var tb = function(a, b) {
        if (a.m) {
            ...
            eb(a.H, c, b) && (M(a.u, c), M(a.I, c), b = a.B.get(c)) && (M(a.B, c), F(b.s(), function(e) {
                e(d)
            }))
        }
    };
    V.prototype.onMessage = function(a) {
        ...
        if (b = Ya(this.K, a.sequenceNumber)) "error" == a.type ? (b = b.g) && b(a.message) : (b = b.l) && b(a.message);
    ...
    var Ab = function(a, b) {
            (a = a.B.get(b.sessionId)) && F(a.s(), function(c) {
                c(!0)
            })
        },
        zb = function(a, b) {
        ...
        Bb = function(a, b) {
            (a = a.u.get(b.sessionId)) && (a = a.get(b.namespaceName)) && F(a.s(), function(c) {
        ...
        xb = RegExp("^([0-9a-zA-Z+/]{4})*(([0-9a-zA-Z+/]{2}==)|([0-9a-zA-Z+/]{3}=))?$"),
        ub = new Set(["PRECACHE"]),
        Z = new V;
    ...
    x("chrome.cast.addReceiverActionListener", chrome.cast.Z);
